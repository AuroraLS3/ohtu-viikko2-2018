...
public class Sovellus {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Komennot ovat lisää(li), poista(p), contains(k), yhdiste(y), erotus(e), leikkaus(le) ja lopetus(quit)(q).");
        ...
        while (true) {
            ...
            if (luettu.equals("lisää") || luettu.equals("li")) {
                ...
                System.out.println("Komennot ovat lisää(li), poista(p), contains(k), yhdiste(y), erotus(e) ja leikkaus(le).");
            }
            System.out.println("Komennot ovat lisää(li), poista(p), contains(k), yhdiste(y), erotus(e) ja leikkaus(le).");
        }
    }
